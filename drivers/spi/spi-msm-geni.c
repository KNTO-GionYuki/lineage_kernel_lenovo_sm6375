					...
					struct spi_master *spi)
{
	...
	/*Linden code for JLINDEN-296 by chenxin at 20221118 start*/
	spi_delay_params = 4 << SPI_CS_CLK_DELAY_SHFT;
	/*Linden code for JLINDEN-296 by chenxin at 20221118 end*/
