...
/* CORE_FW */
	...
	#define fw_addr_support_pen					0x10007410
	...
	#define fw_addr_pen_id_wt					0x10007418
	#define fw_addr_pen_id_rd					0x1000741c
#endif
...
/* CORE_SRAM */
	#define PANEL_PORTRAIT_0_HDSK_PWD		0x00000000
	#define PANEL_LANDSCAPE_90_HDSK_PWD		0xA33AA33A
	#define PANEL_LANDSCAPE_180_HDSK_PWD		0xA55AA55A
	#define PANEL_LANDSCAPE_270_HDSK_PWD	0xA11AA11A
	#define GAME_MODE_ENABLE		0xA55A0000
	#define NORMAL_MODE_ENABLE		0xA55AA55A
	#define PEN_MODE_ENABLE			0x0000A55A
	/*Linden code for JLINDEN-7255 by dingying3 at 20230411 start*/
	#define SUPPORT_PEN_DISABLE		0x00000000
	#define SUPPORT_PEN_ENABLE		0xA55AA55A
	/*Linden code for JLINDEN-7255 by dingying3 at 20230411 end*/
#if defined(Lenovo_pen_id_fun)
	#define PEN_ID_RD_EN			0xA55AA55A
	#define PEN_ID_RD_DIS			0x00000000
	#define PEN_ID_RD_DOING			0xA33AA33A
	#define PEN_ID_RD_OVER			0x5AA55AA5
	#define RTN_AP_PEN_ID_OK		0xA55A
	#define RTN_AP_PEN_ID_ERR		0x5AA5
	#define RTN_AP_PEN_ID_NOT_START	0x0000
#endif
/* CORE_DRIVER */
...
struct fw_operation {
	...
	/*Linden code for JLINDEN-3952 by chenxin at 20230306 start*/
	uint8_t addr_support_pen[4];
	/*Linden code for JLINDEN-3952 by chenxin at 20230306 end*/
	uint8_t addr_prevent_notch[4];
#if defined(Lenovo_pen_id_fun)
	uint8_t addr_pen_id_en[4];
	uint8_t addr_pen_id_data[4];
#endif
...
/* CORE_DRIVER */
	...
	/*Linden code for JLINDEN-3952 by chenxin at 20230306 start*/
	void (*fp_set_support_pen)(uint8_t mode);
	/*Linden code for JLINDEN-3952 by chenxin at 20230306 end*/
#if defined(Lenovo_pen_id_fun)
	void (*fp_set_pen_id_mode)(uint8_t mode);
	uint16_t (*fp_read_pen_id_mode)(void);
#endif
	uint8_t (*fp_read_game_mode)(void);
	/*Linden code for JLINDEN-3952 by chenxin at 20230306 start*/
	uint8_t (*fp_read_support_pen)(void);
	/*Linden code for JLINDEN-3952 by chenxin at 20230306 end*/
	/* Linden code for JLINDEN-11049 by dingying at 20231024 start */
	int (*fp_set_prevent_notch)(int32_t *data);
