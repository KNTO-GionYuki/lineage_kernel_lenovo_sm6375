...
s32 exfat_find_dir_entry(struct super_block *sb, CHAIN_T *p_dir, UNI_NAME_T *p_uniname, s32 num_entries, DOS_NAME_T *p_dosname, u32 type)
{
	...
	u32 entry_type;
	//LINDEN code for JLINDEN-642 by yujiaxing at 20230106 start
	u16 entry_uniname[256], *uniname = NULL, unichar;
	//LINDEN code for JLINDEN-642 by yujiaxing at 20230106 end
	CHAIN_T clu;
	DENTRY_T *ep;
	FILE_DENTRY_T *file_ep;
	STRM_DENTRY_T *strm_ep;
